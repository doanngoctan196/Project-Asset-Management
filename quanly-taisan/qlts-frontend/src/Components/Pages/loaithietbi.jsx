...
class loaitb extends Component {
    ...
    getLoaiChaFirst = async () => {
        try {
            ...
            console.log(this.state.defaultSelectKey);
    ...
    render() {
        const { loading, selectedRowKeys, loaitb } = this.state;
        const rowSelection = {
            selectedRowKeys,
                            ...
                            <Form id="addloaitbForm" onSubmit={this.handleSubmit}>
                                ...
                                >
                                    {getFieldDecorator('maLoai', {
                                        ...
                                        rules: [{
                                            required: true, message: 'Yêu cầu nhập Mã loại chỉ với 2 ký tự!',
                                        }],
                                    })(
                                ...
                                >
                                    {getFieldDecorator('maLoaiCha', {
                                        initialValue: this.state.dataForm.maLoaiCha
                                    })(
                                        this.state.themLoaiCha === true ?
                                            <Select
                                                initialValue={this.state.dataForm.maLoaiCha}
