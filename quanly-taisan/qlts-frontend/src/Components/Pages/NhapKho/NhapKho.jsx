                    ...
                    <div id="addTinhTrangFrom" className="ant-form ant-form-horizontal">
                        ...
                        <div className="ant-row ant-form-item">
                            ...
                            <div className="ant-form-item-control-wrapper ant-col-xs-24 ant-col-sm-16">
                                <div className="ant-form-item-control">
                                    <span className="ant-form-item-children">
                                        <NumericInput max={500} lablefrefix="-> Press [Enter]" labletext={"Nhập sô lượng"} style={{ width: '100%' }} value={this.state.soLuong} onChange={this.onChangeSoLuong} onKeyPress={this.handkeUpdateSoLuong} />
                                    </span>
                                </div>
                            </div>
                        </div>
