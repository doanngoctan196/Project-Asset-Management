...
class NhanVien extends Component {
    ...
    render() {
        var { loading, selectedRowKeys, filtersName, filter, data } = this.state;
        if (filter) {
            if (filter.name) {
                    ...
                    <Form id="nhanVienFrom" onSubmit={this.handleSubmit}>
                        ...
                        >
                            {getFieldDecorator('maChucVu', {
                                ...
                                >
                                    {
                                        this.state.chucvus.map(element => <Option key={element.maChucVu} value={element.maChucVu}>{element.tenChucVu}</Option>)
                                    }
                                </Select>
                            )}
                        </Form.Item>
